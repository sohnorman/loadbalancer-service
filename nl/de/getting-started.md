...
Wählen Sie für den Einstieg in den IBM Cloud Load Balancer-Service **Netz > Lastausgleichsfunktionen > IBM Cloud Load Balancer** im Cloud-Katalog aus und führen Sie anschließend die folgende Prozedur aus:
