...
Se você tiver problemas ou perguntas ao usar o serviço IBM Cloud Load Balancer, será possível obter ajuda procurando informações ou fazendo perguntas por meio de um dos fóruns listados abaixo. Também é possível abrir um chamado de suporte.
...
* Se você tiver questões técnicas sobre o serviço IBM Cloud Load Balancer, poste sua pergunta no [Stack Overflow](https://stackoverflow.com/search?q=lbaas+ibm-bluemix) e identifique-a com "lbaas" e "ibm-bluemix".
